...
The following is a dendrogram of the clusters shown in Figure 1. The original code for the plot that was rendered in the paper is in the file "finalDendro.R". 
...
The parallel coordinate plot has a line for each of the weather stations that shows the indicated summary statistic for each of the clustering variables. The lines are colored according to the cluster that they belong to. Stations in the Southwest cluster are emphasized. The original code for the plot that was rendered in the paper is in the file "final_PCP.R". 
...
These scatterplots are examples of graphs generated by our shiny app. The app allows the user to select points on the scatterplot and see where they are located on the map. Original code for creating the pdf image used in the paper see the file "final_Scatterplot_Lag.R". 
...
Original code for creating the pdf image used in the paper see the file "sampleEllipse.R". 

...
## hullSelectedSites.R
##
## A modification of hte main function that selects all the NCDC sites within
##   a convex Hull.  This is done for the demonstration in paper/presentation
...
selectedSitesHull = function(weights, buffer=0.5){
  ...
  list(hull, locations$AirPtCd[which(overlay == 1)])
}
